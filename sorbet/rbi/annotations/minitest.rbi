...
module Minitest::Assertions
  ...
  # Overloaded sigs not supported in sorbet 0.5.x; merged into one sig.
  sig { type_parameters(:T).params(exp: T.any(T::Class[T.type_parameter(:T)], Regexp, String, NilClass), block: T.proc.void).returns(T.type_parameter(:T)) }
