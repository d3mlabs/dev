...
class SimpleCov::Formatter::CoberturaFormatter
  ...
  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#153
  ...
  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#189
  def extract_rate(percent); end

  # Roughly mirrors private method SimpleCov::Formatter::HTMLFormatter#output_coverage
  #
  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#178
  def output_message(result, output_path); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#193
  def project_root; end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#185
  def resolve_filename(filename); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#37
  def result_to_xml(result); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#140
  def set_branch_attributes(line, file_line, branches_by_line); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#121
  def set_class_attributes(class_, file); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#92
  def set_coverage_attributes(coverage, result); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#135
  def set_line_attributes(line, file_line); end

  # source://simplecov-cobertura//lib/simplecov-cobertura.rb#109
