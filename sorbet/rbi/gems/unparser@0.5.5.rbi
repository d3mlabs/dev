...
module Unparser
  class << self
    ...
    def consume_diagnostic(diagnostic); end
  end
end
...
class Unparser::Emitter::Hash < ::Unparser::Emitter
  ...
  def emit_hash_member(node); end
  def emit_heredoc_reminder_member(node); end
  def emit_pair(pair); end
end

Unparser::Emitter::Hash::BAREWORD = T.let(T.unsafe(nil), Regexp)
...
class Unparser::Writer::Send
  ...
  def emit_argument(argument, last); end
  def emit_arguments; end
