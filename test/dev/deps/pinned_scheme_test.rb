...
class Dev::Deps::PinnedSchemeTest < Minitest::Test
  ...
  test "every reported version satisfies every constraint" do
    ...
    scheme.satisfies?(pv("a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0"), { "tag" => "v1.2.3" })
    scheme.satisfies?(pv("5.6.1-css-83"), { "tag" => "5.6.1-css-83" })
    scheme.satisfies?(pv("20240101"), { "buildid" => "20240101" })
    scheme.satisfies?(pv("26.1.1"), {})
  end
